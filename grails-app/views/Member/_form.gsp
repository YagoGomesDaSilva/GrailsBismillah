<div class="mb-3">
    <label class="form-label"><g:message code="first.name"/> *</label>
...
<div class="mb-3">
    <label class="form-label"><g:message code="last.name"/></label>
    <g:textField name="lastName" class="form-control" value="${member?.lastName}" placeholder="Please Last Name"/>
</div>

<div class="mb-3">
    <label class="form-label"><g:message code="email.address"/> *</label>
...
<g:if test="${!edit}">
    <div class="mb-3">
        <label class="form-label"><g:message code="password"/> *</label>
